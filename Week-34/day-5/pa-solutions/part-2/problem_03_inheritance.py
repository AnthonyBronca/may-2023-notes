...
class FlyingDragon(Dragon):
    ...
    # @property # GETTER -> gets is_good -> let's you invoke varialbe using self.is_good instead of self._is_good
    # def is_good(self):
    #     return self._is_good

    # @is_good.setter # Setter -> sets _is_good -> let's you reassign varialbe using self.is_good instead of self._is_good
    # def is_good(self):
...
print(
    test_dragon.encounter()
)  # While traveling you suddenly meet a flying dragon named Smaug! Smaug breathes fire everywhere! BURN!!!
print(
    test_dragon.fly()
)  # Smaug's towering wings launch it into the air, creating a powerful blast of wind that knocks you over.
